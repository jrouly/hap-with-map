...
public class VectorizationJob extends InputJob {
	...
	protected void printConfiguredParameters() { 
		System.out.println("[INFO]: Reuters Vectorization Job" );
		...
		System.out.println("\t--tf_idf\t" + tf_tfidf);
		System.out.println();
	}
	...
	public int run(String[] args) throws Exception {
		...
		System.out.println("--------------------------");
		System.out.println("\tInput: " + vectorDirectory + "/" + tf_tfidf
				+ "-vectors");
		...
		String[] arguments_CreateSimilaritySimilarityJob = { 
				"-i",   vectorDirectory + "/" + tf_tfidf + "-vectors" , 
