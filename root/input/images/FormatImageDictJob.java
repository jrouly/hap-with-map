 ...
 * 
 */
public class FormatImageDictJob extends InputJob {
	...
	public int run(String[] args) throws Exception {
		...
		Text r = new Text ("R\t0");
		wordDictWriter.append(new Text(), r);

		Text g = new Text ("G\t1");
		wordDictWriter.append(new Text(), g);

		Text b = new Text ("B\t1");
		wordDictWriter.append(new Text(), b);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(),new FormatImageDictJob(),args);
		System.exit(res);
	}
}
